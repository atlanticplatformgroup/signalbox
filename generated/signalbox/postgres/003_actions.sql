...
BEGIN
  ...
  VALUES ('model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'action:act_d10d1618ed4045f396b64fc3745ce3dd', v_principal_id, v_idempotency_key, v_request_hash, v_correlation_id, v_causation_id)
  ...
  IF v_receipt_id IS NULL THEN
    ...
    IF v_receipt_source_hash IS DISTINCT FROM 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e' OR v_receipt_request_hash IS DISTINCT FROM v_request_hash THEN
...
;
  ...
  VALUES ('action:act_d10d1618ed4045f396b64fc3745ce3dd', session_user, v_principal_id, v_result."id", v_identity_issuer, v_identity_subject, 'model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'authorize:action:act_d10d1618ed4045f396b64fc3745ce3dd', 'executed', v_authority_policy_id, v_authority_id, pg_catalog.jsonb_build_object('version', 2, 'outcome', 'executed', 'model', pg_catalog.jsonb_build_object('id', 'model:Signalbox', 'version', '0.50.0', 'sourceHash', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e'), 'actionId', 'action:act_d10d1618ed4045f396b64fc3745ce3dd', 'command', pg_catalog.jsonb_build_object('correlationId', v_correlation_id, 'causationId', v_causation_id, 'receiptId', v_receipt_id), 'authorization', pg_catalog.jsonb_build_object('ruleId', 'authorize:action:act_d10d1618ed4045f396b64fc3745ce3dd', 'outcome', 'passed', 'policyId', v_authority_policy_id, 'authorityId', v_authority_id), 'requirements', pg_catalog.jsonb_build_array(pg_catalog.jsonb_build_object('ruleId', 'require:action:act_d10d1618ed4045f396b64fc3745ce3dd.production_target', 'outcome', 'passed', 'policyIds', pg_catalog.jsonb_build_array()))), v_correlation_id, v_causation_id, v_receipt_id)
...
BEGIN
  ...
  INSERT INTO "model_signalbox_internal"."command_receipt" ("model_id", "model_version", "source_hash", "action_id", "principal_id", "idempotency_key", "request_hash", "correlation_id", "causation_id")
  VALUES ('model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'action:act_047a601f15384b5ea4bfa05b5ef72676', v_principal_id, v_idempotency_key, v_request_hash, v_correlation_id, v_causation_id)
  ON CONFLICT ("principal_id", "action_id", "idempotency_key") DO NOTHING
  RETURNING "id" INTO v_receipt_id;
...
;
  ...
  INSERT INTO "model_signalbox_internal"."action_audit" ("action_id", "database_principal", "principal_id", "target_id", "identity_issuer", "identity_subject", "model_id", "model_version", "source_hash", "authorization_rule_id", "decision_outcome", "policy_id", "authority_id", "decision_evidence", "correlation_id", "causation_id", "command_receipt_id")
  VALUES ('action:act_047a601f15384b5ea4bfa05b5ef72676', session_user, v_principal_id, v_result."id", v_identity_issuer, v_identity_subject, 'model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'authorize:action:act_047a601f15384b5ea4bfa05b5ef72676', 'executed', v_authority_policy_id, v_authority_id, pg_catalog.jsonb_build_object('version', 2, 'outcome', 'executed', 'model', pg_catalog.jsonb_build_object('id', 'model:Signalbox', 'version', '0.50.0', 'sourceHash', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e'), 'actionId', 'action:act_047a601f15384b5ea4bfa05b5ef72676', 'command', pg_catalog.jsonb_build_object('correlationId', v_correlation_id, 'causationId', v_causation_id, 'receiptId', v_receipt_id), 'authorization', pg_catalog.jsonb_build_object('ruleId', 'authorize:action:act_047a601f15384b5ea4bfa05b5ef72676', 'outcome', 'passed', 'policyId', v_authority_policy_id, 'authorityId', v_authority_id), 'requirements', pg_catalog.jsonb_build_array(pg_catalog.jsonb_build_object('ruleId', 'require:action:act_047a601f15384b5ea4bfa05b5ef72676.awaiting_approval', 'outcome', 'passed', 'policyIds', pg_catalog.jsonb_build_array()))), v_correlation_id, v_causation_id, v_receipt_id)
  RETURNING "id" INTO v_action_audit_id;
...
BEGIN
  ...
  INSERT INTO "model_signalbox_internal"."command_receipt" ("model_id", "model_version", "source_hash", "action_id", "principal_id", "idempotency_key", "request_hash", "correlation_id", "causation_id")
  VALUES ('model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'action:act_4a9421bfc2e744969b9f73109e6cda54', v_principal_id, v_idempotency_key, v_request_hash, v_correlation_id, v_causation_id)
  ON CONFLICT ("principal_id", "action_id", "idempotency_key") DO NOTHING
  RETURNING "id" INTO v_receipt_id;
...
;
  ...
  INSERT INTO "model_signalbox_internal"."action_audit" ("action_id", "database_principal", "principal_id", "target_id", "identity_issuer", "identity_subject", "model_id", "model_version", "source_hash", "authorization_rule_id", "decision_outcome", "policy_id", "authority_id", "decision_evidence", "correlation_id", "causation_id", "command_receipt_id")
  VALUES ('action:act_4a9421bfc2e744969b9f73109e6cda54', session_user, v_principal_id, v_result."id", v_identity_issuer, v_identity_subject, 'model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'authorize:action:act_4a9421bfc2e744969b9f73109e6cda54', 'executed', v_authority_policy_id, v_authority_id, pg_catalog.jsonb_build_object('version', 2, 'outcome', 'executed', 'model', pg_catalog.jsonb_build_object('id', 'model:Signalbox', 'version', '0.50.0', 'sourceHash', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e'), 'actionId', 'action:act_4a9421bfc2e744969b9f73109e6cda54', 'command', pg_catalog.jsonb_build_object('correlationId', v_correlation_id, 'causationId', v_causation_id, 'receiptId', v_receipt_id), 'authorization', pg_catalog.jsonb_build_object('ruleId', 'authorize:action:act_4a9421bfc2e744969b9f73109e6cda54', 'outcome', 'passed', 'policyId', v_authority_policy_id, 'authorityId', v_authority_id), 'requirements', pg_catalog.jsonb_build_array(pg_catalog.jsonb_build_object('ruleId', 'require:action:act_4a9421bfc2e744969b9f73109e6cda54.approved', 'outcome', 'passed', 'policyIds', pg_catalog.jsonb_build_array()), pg_catalog.jsonb_build_object('ruleId', 'require:action:act_4a9421bfc2e744969b9f73109e6cda54.allowance_same_org', 'outcome', 'passed', 'policyIds', pg_catalog.jsonb_build_array()))), v_correlation_id, v_causation_id, v_receipt_id)
  RETURNING "id" INTO v_action_audit_id;
...
BEGIN
  ...
  INSERT INTO "model_signalbox_internal"."command_receipt" ("model_id", "model_version", "source_hash", "action_id", "principal_id", "idempotency_key", "request_hash", "correlation_id", "causation_id")
  VALUES ('model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'action:act_18ab026d358144dfa4d1729e40dd832e', v_principal_id, v_idempotency_key, v_request_hash, v_correlation_id, v_causation_id)
  ON CONFLICT ("principal_id", "action_id", "idempotency_key") DO NOTHING
  RETURNING "id" INTO v_receipt_id;
...
;
  ...
  v_response := jsonb_build_object('id', v_result."id", 'createdAt', v_result."created_at", 'org', v_result."org_id", 'requestedBy', v_result."requested_by_id", 'environment', v_result."environment_id", 'commitSha', v_result."commit_sha", 'status', v_result."status", 'approvedBy', v_result."approved_by_id", 'approvedByRoles', v_result."approved_by_roles");
  INSERT INTO "model_signalbox_internal"."action_audit" ("action_id", "database_principal", "principal_id", "target_id", "identity_issuer", "identity_subject", "model_id", "model_version", "source_hash", "authorization_rule_id", "decision_outcome", "policy_id", "authority_id", "decision_evidence", "correlation_id", "causation_id", "command_receipt_id")
  VALUES ('action:act_18ab026d358144dfa4d1729e40dd832e', session_user, v_principal_id, v_result."id", v_identity_issuer, v_identity_subject, 'model:Signalbox', '0.50.0', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e', 'authorize:action:act_18ab026d358144dfa4d1729e40dd832e', 'executed', v_authority_policy_id, v_authority_id, pg_catalog.jsonb_build_object('version', 2, 'outcome', 'executed', 'model', pg_catalog.jsonb_build_object('id', 'model:Signalbox', 'version', '0.50.0', 'sourceHash', 'sha256:c05d742f0b6c8e9a06ee09732d45a9e73af1e8508dfe2d2ee1706df175c6356e'), 'actionId', 'action:act_18ab026d358144dfa4d1729e40dd832e', 'command', pg_catalog.jsonb_build_object('correlationId', v_correlation_id, 'causationId', v_causation_id, 'receiptId', v_receipt_id), 'authorization', pg_catalog.jsonb_build_object('ruleId', 'authorize:action:act_18ab026d358144dfa4d1729e40dd832e', 'outcome', 'passed', 'policyId', v_authority_policy_id, 'authorityId', v_authority_id), 'requirements', pg_catalog.jsonb_build_array(pg_catalog.jsonb_build_object('ruleId', 'require:action:act_18ab026d358144dfa4d1729e40dd832e.awaiting_approval', 'outcome', 'passed', 'policyIds', pg_catalog.jsonb_build_array()))), v_correlation_id, v_causation_id, v_receipt_id)
  RETURNING "id" INTO v_action_audit_id;
