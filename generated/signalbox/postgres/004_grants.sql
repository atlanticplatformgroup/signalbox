...
GRANT EXECUTE ON FUNCTION "model_signalbox"."dispatch_issue_creation"(uuid, uuid) TO modellang_app;
REVOKE ALL ON FUNCTION "model_signalbox"."decide_act_cbb72fd307704ab3927aa4bea8112fbf"(uuid, uuid, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "model_signalbox"."decide_act_cbb72fd307704ab3927aa4bea8112fbf"(uuid, uuid, text) TO modellang_app;
REVOKE ALL ON FUNCTION "model_signalbox"."dispatch_pull_request"(uuid, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "model_signalbox"."dispatch_pull_request"(uuid, uuid) TO modellang_app;
REVOKE ALL ON FUNCTION "model_signalbox"."decide_act_3e99da927be642efac3d1bee026ef00a"(uuid, uuid, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "model_signalbox"."decide_act_3e99da927be642efac3d1bee026ef00a"(uuid, uuid, text) TO modellang_app;
REVOKE ALL ON FUNCTION "model_signalbox"."dispatch_staging_deployment"(uuid, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "model_signalbox"."dispatch_staging_deployment"(uuid, uuid) TO modellang_app;
REVOKE ALL ON FUNCTION "model_signalbox"."decide_act_3e26a4d454634bf3a2058204146d7c45"(uuid, uuid, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "model_signalbox"."decide_act_3e26a4d454634bf3a2058204146d7c45"(uuid, uuid, text) TO modellang_app;
REVOKE ALL ON FUNCTION "model_signalbox"."dispatch_approved_deployment"(uuid, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "model_signalbox"."dispatch_approved_deployment"(uuid, uuid) TO modellang_app;
...
GRANT EXECUTE ON FUNCTION "model_signalbox"."dispatch_approved_schema_migration"(uuid, uuid) TO modellang_app;
REVOKE ALL ON FUNCTION "model_signalbox"."decide_act_70d3862584094631aca61e9db664d991"(uuid, uuid, text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION "model_signalbox"."decide_act_70d3862584094631aca61e9db664d991"(uuid, uuid, text) TO modellang_app;
