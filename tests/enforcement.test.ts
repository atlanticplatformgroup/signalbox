...
const REPOSITORY = "00000000-0000-0000-0000-0000000000d1";
const OTHER_REPOSITORY = "00000000-0000-0000-0000-0000000000d9";
const ENV_PROD = "00000000-0000-0000-0000-0000000000e1";
const ENV_STAGING = "00000000-0000-0000-0000-0000000000e2";
const ENV_DATABASE = "00000000-0000-0000-0000-0000000000e3";
const CONNECTOR_GITHUB = "00000000-0000-0000-0000-0000000000c1";
const CONNECTOR_DEPLOY = "00000000-0000-0000-0000-0000000000c2";
const CONNECTOR_DATABASE = "00000000-0000-0000-0000-0000000000c3";
const CONNECTOR_OTHER = "00000000-0000-0000-0000-0000000000c9";
const DELEGATION_ISSUE = "00000000-0000-0000-0000-0000000000f1";
const DELEGATION_PULL = "00000000-0000-0000-0000-0000000000f2";
const DELEGATION_STAGING = "00000000-0000-0000-0000-0000000000f3";
const DELEGATION_PROD = "00000000-0000-0000-0000-0000000000f4";
const DELEGATION_MIGRATION = "00000000-0000-0000-0000-0000000000f5";
const ALLOWANCES = [
...
describe("production approval and separation of duties", () => {
  ...
  it("rejects cross-tenant and unauthorized human approvers", async () => {
    ...
    sql(`UPDATE model_signalbox.principal SET roles='{MEMBER}' WHERE id='00000000-0000-0000-0000-0000000000b2';`);
    await expect(
...
describe("exactly-once dispatch and allowance consumption", () => {
  ...
  it("rejects an allowance owned by another principal", async () => {
    const request = await requestIssue();
    sql(`UPDATE model_signalbox.allowance SET agent_id='00000000-0000-0000-0000-0000000000b6' WHERE id='${ALLOWANCES[0]}';`);
    await expect(
      connectorWorker.execute(
        OP.dispatchIssue,
        { request, allowance: ALLOWANCES[0] },
